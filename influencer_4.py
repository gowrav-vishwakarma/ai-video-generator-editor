...
def generate_image_then_video_chunk(
    ...
    # Get generation dimensions from config
    gen_width, gen_height = config.generation_resolution
    print(f"Scene {scene_idx}, Chunk {chunk_idx}: SDXL target image size: {gen_width}x{gen_height}")
    ...
    video_frames = i2v_pipe(
        ...
        height=gen_height,  # Explicitly set output height
        width=gen_width     # Explicitly set output width
    ).frames[0]
...
def generate_direct_video_chunk(
    ...
    # Get generation dimensions from config
    gen_width, gen_height = config.generation_resolution
    print(f"Scene {scene_idx}, Chunk {chunk_idx}: Using video dimensions {gen_width}x{gen_height}")

    # Generate video frames with dimensions from config
...
if __name__ == "__main__":
    ...
    reel_topic = "explining about life to genz in their own slangs."
...
# instagram_config = ContentConfig(
#     target_resolution=(1080, 1920),  # 9:16 aspect ratio
#     output_dir="instagram_content"
# )

# # For YouTube Videos (16:9)
# youtube_config = ContentConfig(
#     target_resolution=(1920, 1080),  # 16:9 aspect ratio
#     output_dir="youtube_content"
# )

# # For YouTube Shorts (9:16)
# youtube_shorts_config = ContentConfig(
#     target_resolution=(1080, 1920),  # 9:16 aspect ratio
#     output_dir="youtube_shorts_content"
# )

# For TikTok (9:16)
# tiktok_config = ContentConfig(
#     target_resolution=(1080, 1920),  # 9:16 aspect ratio
#     output_dir="tiktok_content"
# )